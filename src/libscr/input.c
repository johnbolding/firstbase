 ...
 *
 *      Not sure why, but in recent Linux flavors, the alarm() can only be
 *         triggered once here, and it never works again!
 *         Without the hack of read_kcheck_done, this code hangs at the read
 *         when two (2) FB_ESCAPE ESCAPE characters are used.
 */
