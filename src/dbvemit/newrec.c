 ...
 *
 * $Id: newrec.c,v 9.0 2001/01/09 02:56:02 john Exp $
 *
...
#ifndef LINT
static char Newrec_sid[] = "@(#) $Id: newrec.c,v 9.0 2001/01/09 02:56:02 john Exp $";
#endif
   ...
   newrec()
	 ...
	 fb_nullall();
	    ...
	    ncur = p->p_nedit[0];
            top = ncur;
            fb_display(1);
	    fb_checkformula(1);		/* for links on 'next' fb_page */
